...
public class SendGridConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(priority = 1, description = "SendGrid {listCategory} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, description = "SendGrid {listMarketingEmail} integration test with mandatory parameters.")
